...
// arguments对象 案例
function foo() {
    var args = Array.from(arguments);// var args = Array.prototype.slice.call(arguments);
    console.log(args);
}
...
// forEach方法
[,'a'].forEach(function(x,i){return console.log(i);});
//1
...
// every方法
[,'a'].every(function(x){return x==='a'}) 
//true

// some方法
[,'a'].some(function(x){return x !== 'a';} ) 
//false

// map方法
[,'a'].map(function (x) {return 1;}) 
//[,1]
